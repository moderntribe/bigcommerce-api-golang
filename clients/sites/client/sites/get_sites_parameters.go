...
// WithLimit adds the limit to the get sites params
func (o *GetSitesParams) WithLimit(limit int64) *GetSitesParams {
	o.SetLimit(limit)
	return o
}

// SetLimit adds the limit to the get sites params
func (o *GetSitesParams) SetLimit(limit int64) {
	o.Limit = limit
}

// WithPage adds the page to the get sites params
func (o *GetSitesParams) WithPage(page int64) *GetSitesParams {
	o.SetPage(page)
	return o
}

// SetPage adds the page to the get sites params
func (o *GetSitesParams) SetPage(page int64) {
	o.Page = page
}
