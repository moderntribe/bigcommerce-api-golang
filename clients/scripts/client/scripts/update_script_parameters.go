...
// WithAccept adds the accept to the update script params
func (o *UpdateScriptParams) WithAccept(accept string) *UpdateScriptParams {
	o.SetAccept(accept)
	return o
}

// SetAccept adds the accept to the update script params
func (o *UpdateScriptParams) SetAccept(accept string) {
	o.Accept = accept
}

// WithContentType adds the contentType to the update script params
func (o *UpdateScriptParams) WithContentType(contentType string) *UpdateScriptParams {
	o.SetContentType(contentType)
	return o
}

// SetContentType adds the contentType to the update script params
func (o *UpdateScriptParams) SetContentType(contentType string) {
	o.ContentType = contentType
}

// WithScriptBody adds the scriptBody to the update script params
func (o *UpdateScriptParams) WithScriptBody(scriptBody UpdateScriptBody) *UpdateScriptParams {
	o.SetScriptBody(scriptBody)
	return o
}

// SetScriptBody adds the scriptBody to the update script params
func (o *UpdateScriptParams) SetScriptBody(scriptBody UpdateScriptBody) {
	o.ScriptBody = scriptBody
}

// WithUUID adds the uuid to the update script params
func (o *UpdateScriptParams) WithUUID(uuid strfmt.UUID) *UpdateScriptParams {
	o.SetUUID(uuid)
	return o
}

// SetUUID adds the uuid to the update script params
func (o *UpdateScriptParams) SetUUID(uuid strfmt.UUID) {
	o.UUID = uuid
}
