...
// ScriptPost script_Post
//
// swagger:model script_Post
...
func (m *ScriptPost) UnmarshalJSON(raw []byte) error {
	// AO0
	var dataAO0 struct {
		Name *string `json:"name"`
	}
...
func (m ScriptPost) MarshalJSON() ([]byte, error) {
...
// Validate validates this script post
func (m *ScriptPost) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ScriptPost) validateName(formats strfmt.Registry) error {
...
var scriptPostTypeConsentCategoryPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		scriptPostTypeConsentCategoryPropEnum = append(scriptPostTypeConsentCategoryPropEnum, v)
	}
}

// property enum
func (m *ScriptPost) validateConsentCategoryEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, scriptPostTypeConsentCategoryPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *ScriptPost) validateConsentCategory(formats strfmt.Registry) error {
...
var scriptPostTypeKindPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		scriptPostTypeKindPropEnum = append(scriptPostTypeKindPropEnum, v)
	}
}

// property enum
func (m *ScriptPost) validateKindEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, scriptPostTypeKindPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *ScriptPost) validateKind(formats strfmt.Registry) error {
...
var scriptPostTypeLoadMethodPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		scriptPostTypeLoadMethodPropEnum = append(scriptPostTypeLoadMethodPropEnum, v)
	}
}

// property enum
func (m *ScriptPost) validateLoadMethodEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, scriptPostTypeLoadMethodPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *ScriptPost) validateLoadMethod(formats strfmt.Registry) error {
...
var scriptPostTypeLocationPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		scriptPostTypeLocationPropEnum = append(scriptPostTypeLocationPropEnum, v)
	}
}

// property enum
func (m *ScriptPost) validateLocationEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, scriptPostTypeLocationPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *ScriptPost) validateLocation(formats strfmt.Registry) error {
...
var scriptPostTypeVisibilityPropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		scriptPostTypeVisibilityPropEnum = append(scriptPostTypeVisibilityPropEnum, v)
	}
}

// property enum
func (m *ScriptPost) validateVisibilityEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, scriptPostTypeVisibilityPropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *ScriptPost) validateVisibility(formats strfmt.Registry) error {
...
func (m *ScriptPost) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *ScriptPost) UnmarshalBinary(b []byte) error {
	var res ScriptPost
