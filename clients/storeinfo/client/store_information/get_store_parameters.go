...
// WithAccept adds the accept to the get store params
func (o *GetStoreParams) WithAccept(accept string) *GetStoreParams {
	o.SetAccept(accept)
	return o
}

// SetAccept adds the accept to the get store params
func (o *GetStoreParams) SetAccept(accept string) {
	o.Accept = accept
}

// WithContentType adds the contentType to the get store params
func (o *GetStoreParams) WithContentType(contentType string) *GetStoreParams {
	o.SetContentType(contentType)
	return o
}

// SetContentType adds the contentType to the get store params
func (o *GetStoreParams) SetContentType(contentType string) {
